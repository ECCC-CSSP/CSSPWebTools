...
namespace CSSPWebTools.Tests.Controllers
{
    ...
    /// </summary>
    [TestClass]
    public class ReportControllerTest : SetupData
    {
        ...
        private ShimReportController shimReportController { get; set; }
        /// <summary>
        ...
        [TestMethod]
        public void ReportController_Constructor_Test()
        {
        ...
        private void SetupTest(ContactModel contactModelToDo, CultureInfo culture, string actionStr)
        {
            ...
            Assert.IsNotNull("Report", controller._RequestContext.RouteData.Values["controller"].ToString());
        ...
        {
            shimReportController = new ShimReportController(controller);
        }
