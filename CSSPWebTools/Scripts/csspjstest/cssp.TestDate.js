...
(function (CSSP) {
    var TestDate = /** @class */ (function () {
        function TestDate() {
            this.DoTest = function ($form, $input, $nextSpan, i) {
                ...
                $form.valid();
                setTimeout(function () {
                    test("Date test for field [" + $input.attr("name") + "]  (" + i + ") [" + cssp.Test.StringTestList[i] + "]", function () {
                    ...
                    if (i < cssp.Test.StringTestList.length) {
                        ...
                        test("Finished date test for form [" + $form.attr("id") + "] field [" + $input.attr("name") + "]", function () {
                            equal(true, true);
    ...
    CSSP.TestDate = TestDate;
})(CSSP || (CSSP = {}));
//# sourceMappingURL=cssp.TestDate.js.map