...
(function (CSSP) {
    ...
    (function (Test) {
                ...
                this.Init = function () {
                    ...
                    $(document).on("click", "a[class^='jt']", function (evt) {
                        ...
                        switch ($ajs.attr("class").split(" ")[0]) {
                            ...
                            default:
                                {
                                    cssp.Dialog.ShowDialogBasic(new CSSP.DialogModel(CSSP.DialogModelTypeEnum.Error, $ajs.attr("class").split(" ")[0], cssp.GetHTMLVariable("#TestVariables", "varNotImplemented") + " in cssp.Test.DocumentButtonEvents.ts"));
                                }
                                break;
                        }
                        return false;
        ...
        Test.DocumentButtonEvents = DocumentButtonEvents;
    })(Test = CSSP.Test || (CSSP.Test = {}));
})(CSSP || (CSSP = {}));
//# sourceMappingURL=cssp.Test.DocumentButtonEvents.js.map