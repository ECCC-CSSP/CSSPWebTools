    ...
    (function (Test) {
        var Header = /** @class */ (function () {
            ...
            function Header() {
                var _this = this;
                // Variables
                this.TSName = "cssp.Header.ts";
                this.appName = "cssp.Header";
                // Function
                // **********************************************************
                // **********************************************************
                // **********************************************************
                this.TestContents = function () {
                    $("#qunit-tests").html("");
                    cssp.Test.RunCheckVariablesAndFunctions(_this.TSName, _this.appName, []);
                    QUnit.module("#HeaderDiv and children");
                    var $cssPath;
                    $cssPath = $("#HeaderDiv");
                    test("#HeaderDiv attributes", function () {
                        equal($cssPath.attr("id"), "HeaderDiv", "id [HeaderDiv]");
                    });
                    $cssPath = $("#HeaderDiv > nav");
                    test("#HeaderDiv > nav attributes", function () {
                    ...
                    test("#HeaderDiv > nav > div > div:eq(0) > button > span:eq(0) attributes", function () {
                        equal($cssPath.attr("class"), "sr-only", "class [sr-only]");
                    });
                    $cssPath = $("#HeaderDiv > nav > div > div:eq(0) > button > span:eq(1)");
                    test("#HeaderDiv > nav > div > div:eq(0) > button > span:eq(1) attributes", function () {
                        equal($cssPath.attr("class"), "icon-bar", "class [icon-bar]");
                    });
                    $cssPath = $("#HeaderDiv > nav > div > div:eq(0) > button > span:eq(2)");
                    test("#HeaderDiv > nav > div > div:eq(0) > button > span:eq(2) attributes", function () {
                        equal($cssPath.attr("class"), "icon-bar", "class [icon-bar]");
                    });
                    $cssPath = $("#HeaderDiv > nav > div > div:eq(0) > button > span:eq(3)");
                    test("#HeaderDiv > nav > div > div:eq(0) > button > span:eq(3) attributes", function () {
                        equal($cssPath.attr("class"), "icon-bar", "class [icon-bar]");
                    });
                    $cssPath = $("#HeaderDiv > nav > div > div:eq(0) > a:eq(0)");
                    test("#HeaderDiv > nav > div > div:eq(0) > a:eq(0) attributes", function () {
                    ...
                    test("#HeaderDiv > nav > div > div:eq(0) > a:eq(0) > span attributes", function () {
                        equal($cssPath.attr("class"), "text-primary", "class [text-primary]");
                    });
                    $cssPath = $("#HeaderDiv > nav > div > div:eq(0) > a:eq(1)");
                    test("#HeaderDiv > nav > div > div:eq(0) > a:eq(1) attributes", function () {
                        equal($cssPath.attr("href"), "#!Home", "href [#!Home]");
                    ...
                    test("#HeaderDiv > nav > div > div:eq(0) > a:eq(1) > span attributes", function () {
                        equal($cssPath.attr("class"), "text-primary", "class [text-primary]");
                    });
                    $cssPath = $("#HeaderDiv > nav > div > div:eq(1)");
                    test("#HeaderDiv > nav > div > div:eq(1) attributes", function () {
                    ...
                    test("#HeaderDiv > nav > div > div:eq(1) > ul:eq(0) attributes", function () {
                    ...
                    test("#HeaderDiv > nav > div > div:eq(1) > ul:eq(0) > li:eq(0) attributes", function () {
                    ...
                    test("#HeaderDiv > nav > div > div:eq(1) > ul:eq(0) > li:eq(0) > a attributes", function () {
                    ...
                    test("#HeaderDiv > nav > div > div:eq(1) > ul:eq(0) > li:eq(0) > a > span attributes", function () {
                        equal($cssPath.attr("class"), "caret", "class [caret]");
                    });
                    $cssPath = $("#HeaderDiv > nav > div > div:eq(1) > ul:eq(0) > li:eq(0) > ul");
                    test("#HeaderDiv > nav > div > div:eq(1) > ul:eq(0) > li:eq(0) > ul attributes", function () {
                    ...
                    test("#HeaderDiv > nav > div > div:eq(1) > ul:eq(0) > li:eq(0) > ul > li:eq(0) > a attributes", function () {
                        equal($cssPath.attr("href"), "#", "href [#]");
                    ...
                    test("#HeaderDiv > nav > div > div:eq(1) > ul:eq(0) > li:eq(0) > ul > li:eq(1) > a attributes", function () {
                        equal($cssPath.attr("href"), "#", "href [#]");
                        equal($cssPath.attr("class"), "jtTestHide", "class [jtTestHide]");
                    });
                    $cssPath = $("#HeaderDiv > nav > div > div:eq(1) > ul:eq(0) > li:eq(0) > ul > li:eq(2)");
                    test("#HeaderDiv > nav > div > div:eq(1) > ul:eq(0) > li:eq(0) > ul > li:eq(2) attributes", function () {
                        equal($cssPath.attr("class"), "divider", "class [divider]");
                    });
                    $cssPath = $("#HeaderDiv > nav > div > div:eq(1) > ul:eq(0) > li:eq(0) > ul > li:eq(3) > a");
                    test("#HeaderDiv > nav > div > div:eq(1) > ul:eq(0) > li:eq(0) > ul > li:eq(3) > a attributes", function () {
                        equal($cssPath.attr("href"), "#", "href [#]");
                    ...
                    test("#HeaderDiv > nav > div > div:eq(1) > ul:eq(0) > li:eq(0) > ul > li:eq(4) attributes", function () {
                        equal($cssPath.attr("class"), "divider", "class [divider]");
                    });
                    $cssPath = $("#HeaderDiv > nav > div > div:eq(1) > ul:eq(0) > li:eq(0) > ul > li:eq(5) > a");
                    test("#HeaderDiv > nav > div > div:eq(1) > ul:eq(0) > li:eq(0) > ul > li:eq(5) > a attributes", function () {
                    ...
                    test("#HeaderDiv > nav > div > div:eq(1) > ul:eq(0) > li:eq(0) > ul > li:eq(5) > a > span attributes", function () {
                    ...
                    test("#HeaderDiv > nav > div > div:eq(1) > ul:eq(0) > li:eq(1) > span attributes", function () {
                    ...
                    test("#HeaderDiv > nav > div > div:eq(1) > ul:eq(0) > li:eq(1) > span > pre attributes", function () {
                    ...
                    test("#HeaderDiv > nav > div > div:eq(1) > ul:eq(0) > li:eq(1) > span > span attributes", function () {
                    ...
                    test("#HeaderDiv > nav > div > div:eq(1) > ul:eq(0) > li:eq(1) > span > span > div attributes", function () {
                        equal($cssPath.attr("class"), "tt-dataset-res", "class [tt-dataset-res]");
                    });
                    $cssPath = $("#HeaderDiv > nav > div > div:eq(1) > ul:eq(1)");
                    test("#HeaderDiv > nav > div > div:eq(1) > ul:eq(1) attributes", function () {
                    ...
                    test("#HeaderDiv > nav > div > div:eq(1) > ul:eq(1) > li:eq(0) > a attributes", function () {
                        equal($cssPath.attr("href"), "#!Home", "href [#!Home]");
                    });
                    $cssPath = $("#HeaderDiv > nav > div > div:eq(1) > ul:eq(1) > li:eq(0) > a > span");
                    test("#HeaderDiv > nav > div > div:eq(1) > ul:eq(1) > li:eq(0) > a > span attributes", function () {
                    ...
                    test("#HeaderDiv > nav > div > div:eq(1) > ul:eq(1) > li:eq(1) > a attributes", function () {
                    ...
                    test("#HeaderDiv > nav > div > div:eq(1) > ul:eq(1) > li:eq(1) > a > span attributes", function () {
                    ...
                    test("#HeaderDiv > nav > div > div:eq(1) > ul:eq(1) > li:eq(2) > a attributes", function () {
                    ...
                    test("#HeaderDiv > nav > div > div:eq(1) > ul:eq(1) > li:eq(2) > a > span:eq(0) attributes", function () {
                    ...
                    test("#HeaderDiv > nav > div > div:eq(1) > ul:eq(1) > li:eq(2) > a > span:eq(1) attributes", function () {
                        equal($cssPath.attr("id"), "UserEmail", "id [UserEmail]");
                    });
                    $cssPath = $("#HeaderDiv > nav > div > div:eq(1) > ul:eq(1) > li:eq(3)");
                    test("#HeaderDiv > nav > div > div:eq(1) > ul:eq(1) > li:eq(3) attributes", function () {
                        equal($cssPath.attr("class"), "divider", "class [divider]");
                    });
                    $cssPath = $("#HeaderDiv > nav > div > div:eq(1) > ul:eq(1) > li:eq(4) > a");
                    test("#HeaderDiv > nav > div > div:eq(1) > ul:eq(1) > li:eq(4) > a attributes", function () {
                    ...
                    test("#HeaderDiv > nav > div > div:eq(1) > ul:eq(1) > li:eq(4) > a > span attributes", function () {
                    ...
                    test("#HeaderDiv > nav > div > div:eq(1) > ul:eq(1) > li:eq(5) attributes", function () {
                        equal($cssPath.attr("class"), "divider", "class [divider]");
                    });
                    $cssPath = $("#HeaderDiv > nav > div > div:eq(1) > ul:eq(1) > li:eq(6) > a");
                    test("#HeaderDiv > nav > div > div:eq(1) > ul:eq(1) > li:eq(6) > a attributes", function () {
                        equal($cssPath.attr("href"), "#!Login", "href [#!Login]");
                        equal($cssPath.attr("class"), "hidden", "class [hidden]");
                    });
                    $cssPath = $("#HeaderDiv > nav > div > div:eq(1) > ul:eq(1) > li:eq(6) > a > span");
                    test("#HeaderDiv > nav > div > div:eq(1) > ul:eq(1) > li:eq(6) > a > span attributes", function () {
                    ...
                    test("#HeaderDiv > nav > div > div:eq(1) > ul:eq(1) > li:eq(7) > a attributes", function () {
                        equal($cssPath.attr("class"), "jaLogOff", "class [jaLogOff]");
                        equal($cssPath.attr("href"), "#", "href [#]");
                    });
                    $cssPath = $("#HeaderDiv > nav > div > div:eq(1) > ul:eq(1) > li:eq(7) > a > span");
                    test("#HeaderDiv > nav > div > div:eq(1) > ul:eq(1) > li:eq(7) > a > span attributes", function () {
                    ...
                    test("#HeaderDiv > nav > div > div:eq(1) > ul:eq(1) > li:eq(8) attributes", function () {
                        equal($cssPath.attr("class"), "divider", "class [divider]");
                    });
                };
...
//# sourceMappingURL=cssp.Test.Header.js.map