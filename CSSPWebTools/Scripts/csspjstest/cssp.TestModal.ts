module CSSP {
    export class TestModal {
        ...
        public DoTest: Function = ($cssPath: JQuery, CurrentCSSPath: string): void => {
            test(CurrentCSSPath + " [modal]", () => {
                ok($cssPath.children().length == 1, "modal has 1 child div");
            });
            var $DivModalDialog: JQuery = $cssPath.children().eq(0);
            test(CurrentCSSPath + " [modal] [modal-dialog]", () => {
            ...
            test(CurrentCSSPath + " [modal] [modal-dialog] [modal-content]", () => {
            ...
            test(CurrentCSSPath + " [modal] [modal-dialog] [modal-content] [modal-header]", () => {
            ...
            test(CurrentCSSPath + " [modal] [modal-dialog] [modal-content] [modal-header] [button]", () => {
            ...
            test(CurrentCSSPath + " [modal] [modal-dialog] [modal-content] [modal-header] [button] [first span]", () => {
            ...
            test(CurrentCSSPath + " [modal] [modal-dialog] [modal-content] [modal-header] [button] [second span]", () => {
            ...
            test(CurrentCSSPath + " [modal] [modal-dialog] [modal-content] [modal-header] [h4]", () => {
            ...
            test(CurrentCSSPath + " [modal] [modal-dialog] [modal-content] [modal-body]", () => {
                ok($DivModelBody.is("div"), "modal-body is div");
                ok($DivModelBody.hasClass("modal-body"), "div has class modal-body");
            });
            test(CurrentCSSPath + " [modal] [modal-dialog] [modal-content] [modal-body] [has tag p, div, form or span]", () => {
            ...
            test(CurrentCSSPath + " [modal] [modal-dialog] [modal-content] [modal-footer]", () => {
                ok($DivModelFooter.is("div"), "modal-footer is div");
                ok($DivModelFooter.hasClass("modal-footer"), "div has class modal-footer");
            });
            test(CurrentCSSPath + " [modal] [modal-dialog] [modal-content] [modal-footer] [buttons]", () => {
            ...
            for (var i = 0, count = $DivModelFooter.children("button").length; i < count; i++) {
                ...
                test(CurrentCSSPath + " [modal] [modal-dialog] [modal-content] [modal-footer] [button] [" + $DivModelFooterButton.text() + "]", () => {
