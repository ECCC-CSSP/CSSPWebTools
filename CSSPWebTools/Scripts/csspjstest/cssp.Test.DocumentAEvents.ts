        ...
        public Init: Function = (): void => {
            ...
            $(document).on("click", "a[class^='jt']", (evt: Event) => {
                ...
                switch ($ajs.attr("class").split(" ")[0]) {
                    ...
                    default:
                        {
                            cssp.Dialog.ShowDialogBasic(new CSSP.DialogModel(DialogModelTypeEnum.Error, $ajs.attr("class").split(" ")[0], cssp.GetHTMLVariable("#TestVariables", "varNotImplemented") + " in cssp.Test.DocumentAEvents.ts"));
                        }
                        break;
                }
                return false;
