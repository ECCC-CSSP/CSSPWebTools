...
module CSSP {
    export class MWQMSite {
        ...
        public DrawTable: Function = (): void => {
            ...
            for (var i = 0; i < cssp.MWQMSite.data.length; i++) {
                ...
                tdataTable.addRow([
                    ...
                    {
                        v: cssp.MWQMSite.data[i].FC, f: "<span " + style + ">" + (cssp.MWQMSite.data[i].FC == null ? "" : cssp.MWQMSite.data[i].FC.toString()) + "</span>",
                    },
                    cssp.MWQMSite.data[i].Sal,
                    cssp.MWQMSite.data[i].Temp,
                    cssp.MWQMSite.data[i].PH,
                    cssp.MWQMSite.data[i].Depth,
                    { v: cssp.MWQMSite.data[i].GeoMean, f: (cssp.MWQMSite.data[i].GeoMean > 14 ? (cssp.MWQMSite.data[i].GeoMean > 88 ? "<span style='color:purple'>" : "<span style='color:red'>") + (cssp.MWQMSite.data[i].GeoMean == null ? "" : Globalize.format(cssp.MWQMSite.data[i].GeoMean, "n0")) + "</span>" : (cssp.MWQMSite.data[i].GeoMean == null ? "" : Globalize.format(cssp.MWQMSite.data[i].GeoMean, "n0"))) },
                    { v: cssp.MWQMSite.data[i].Median, f: (cssp.MWQMSite.data[i].Median > 14 ? (cssp.MWQMSite.data[i].Median > 88 ? "<span style='color:purple'>" : "<span style='color:red'>") + (cssp.MWQMSite.data[i].Median == null ? "" : Globalize.format(cssp.MWQMSite.data[i].Median, "n0")) + "</span>" : (cssp.MWQMSite.data[i].Median == null ? "" : Globalize.format(cssp.MWQMSite.data[i].Median, "n0"))) },
        ...
        public MWQMSubsectorAnalysisExportToExcelDocument: Function = (): void => {
            cssp.Dialog.ShowDialogMessage("Not implemented yet");
        };
        public MWQMSubsectorAnalysisSaveForFutureReportProduction: Function = (): void => {
            cssp.Dialog.ShowDialogMessage("Not implemented yet");
            //let SavingForReport$ = $("#MWQMSubsectorAnalysisDiv").find(".SavingForReport");
            //SavingForReport$.text(SavingForReport$.data("saving"));
