...
(function (CSSP) {
    var MWQMSite = /** @class */ (function () {
        ...
        function MWQMSite() {
            ...
            this.StopRecalculation = false;
            // Functions
            this.InitAnalysisForYear = function () {
                $("select[name='Year']").off("change");
                $("select[name='Year']").on("change", function () {
                    var TVItemID = parseInt($("#ViewDiv").data("tvitemid"));
                    var Year = $("select[name='Year']").val();
                    var command = "MWQM/_mwqmAnalysisReportParameterListForYear";
            ...
            this.AskToRemoveMWQMAnalysisReportParameter = function ($bjs) {
                var AnalysisName = $bjs.closest(".MWQMAnalysisReportParameter").find(".AnalysisName").text();
                var AnalysisReportYear = $bjs.closest(".MWQMAnalysisReportParameter").find(".AnalysisReportYear").text();
                var Command = $bjs.closest(".MWQMAnalysisReportParameter").find(".Command").text();
                if (Command == "Report") {
            ...
            this.MWQMSiteFileDownload = function ($bjs) {
            ...
            this.AfterLoadParameter = function () {
                $("select[name='MWQMAnalysisReportParameterSave']").off("change");
                $("select[name='MWQMAnalysisReportParameterSave']").on("change", function () {
                    $("span.MWQMAnalysisExportToExcelIcon").removeClass("hidden").addClass("hidden");
                    var value = $("select[name='MWQMAnalysisReportParameterSave']").val();
                    if (value == "Empty") {
                        var MWQMAnalysisReportParameterID = 0;
                        ...
                        var MWQMAnalysisReportParameterID = parseInt(value.replace("View_", ""));
                        var TextShown = $("select[name='MWQMAnalysisReportParameterSave']").text();
                ...
                $("select[name='MWQMAnalysisExportToExcel']").on("change", function () {
                    $("span.MWQMAnalysisReportParameterSaveIcon").removeClass("hidden").addClass("hidden");
                    var value = $("select[name='MWQMAnalysisExportToExcel']").val();
                    if (value == "Empty") {
                        var MWQMAnalysisReportParameterID = 0;
            ...
            this.ShowOnlyTheSelectedMWQMAnalysisReportParameter = function (MWQMAnalysisReportParameterID) {
                $(".MWQMAnalysisReportParameter").each(function (ind, elem) {
                    var id = parseInt($(elem).data("parameterid"));
                    if (id == MWQMAnalysisReportParameterID) {
                        $(elem).removeClass("hidden");
                        var RunsToOmitText = $(elem).find(".RunsToOmit").text();
                        var RunsIDs = RunsToOmitText.split(",");
                        RunsToOmitText = "";
                        for (var i = 0, count = RunsIDs.length; i < count; i++) {
            ...
            this.MWQMSubsectorAnalysisReportParameterOrExcelDelete = function ($bjs) {
                var SubsectorTVItemID = parseInt($("#ViewDiv").data("tvitemid"));
                var MWQMAnalysisReportParameterID = parseInt($bjs.closest(".MWQMAnalysisReportParameter").data("parameterid"));
                var command = "MWQM/PostDeleteMWQMAnalysisReportParameterJSON";
            ...
            this.MWQMSubsectorAnalysisReportParameterOrExcelLoad = function ($bjs) {
                cssp.MWQMSite.StopRecalculation = true;
                var $MWQMAnalysisReportParameter = $bjs.closest(".MWQMAnalysisReportParameter");
                $(".jbMWQMSubsectorAnalysisRemoveFromStat").each(function (ind, elem) {
                    var runcount = parseInt($(elem).closest(".MWQMRun").data("runcount"));
                    cssp.MWQMSite.mwqmSubsectorAnalysisModel.mwqmRunAnalysisModelList[runcount].RemoveFromStat = false;
                    $(elem).removeClass("btn-danger").removeClass("btn-success").removeClass("btn-default").addClass("btn-default");
                });
                $("select.MWQMSubsectorAnalysisStartDate").val($MWQMAnalysisReportParameter.find(".StartDate").data("startdate"));
                $("select.MWQMSubsectorAnalysisEndDate").val($MWQMAnalysisReportParameter.find(".EndDate").data("enddate"));
                $("select.MWQMSubsectorAnalysisRuns").val($MWQMAnalysisReportParameter.find(".NumberOfRuns").data("numberofruns"));
                $("select.MWQMSubsectorAnalysisCalculateType").val($MWQMAnalysisReportParameter.find(".AnalysisCalculationType").data("analysiscalculationtype"));
                $("select.MWQMSubsectorAnalysisHighlightSalinityDeviationFromAverage").val($MWQMAnalysisReportParameter.find(".SalinityHighlightDeviationFromAverage").data("salinityhighlightdeviationfromaverage"));
                $("select[name='UpperRainLimitStillConsideredDry1']").val($MWQMAnalysisReportParameter.find(".DryLimit24h").data("drylimit24h"));
                $("select[name='UpperRainLimitStillConsideredDry2']").val($MWQMAnalysisReportParameter.find(".DryLimit48h").data("drylimit48h"));
                $("select[name='UpperRainLimitStillConsideredDry3']").val($MWQMAnalysisReportParameter.find(".DryLimit72h").data("drylimit72h"));
                $("select[name='UpperRainLimitStillConsideredDry4']").val($MWQMAnalysisReportParameter.find(".DryLimit96h").data("drylimit96h"));
                $("select[name='LowerRainLimitConsideredRain1']").val($MWQMAnalysisReportParameter.find(".WetLimit24h").data("wetlimit24h"));
                $("select[name='LowerRainLimitConsideredRain2']").val($MWQMAnalysisReportParameter.find(".WetLimit48h").data("wetlimit48h"));
                $("select[name='LowerRainLimitConsideredRain3']").val($MWQMAnalysisReportParameter.find(".WetLimit72h").data("wetlimit72h"));
                $("select[name='LowerRainLimitConsideredRain4']").val($MWQMAnalysisReportParameter.find(".WetLimit96h").data("wetlimit96h"));
                if ($MWQMAnalysisReportParameter.find(".FullYear").data("fullyear") == "True") {
                    $("input.SelectFullYear").prop('checked', true);
                }
                else {
                    $("input.SelectFullYear").prop('checked', false);
                }
                $("input[name='ShortRange']").val($MWQMAnalysisReportParameter.find(".ShortRangeNumberOfDays").data("shortrangenumberofdays"));
                $("input[name='ShortRange']").val($MWQMAnalysisReportParameter.find(".MidRangeNumberOfDays").data("midrangenumberofdays"));
                var allRunsToOmit = $MWQMAnalysisReportParameter.find(".RunsToOmit").data("runstoomit");
                var RunsToOmitList = allRunsToOmit.split(",");
                var _loop_1 = function (i, count) {
                    if (RunsToOmitList[i].length > 0) {
                        $("td.MWQMRun").each(function (int, elem) {
                ...
                for (var i = 0, count = RunsToOmitList.length; i < count; i++) {
                    _loop_1(i, count);
                }
                $("input.MWQMAnalysisTableDataType[name='DataTypeTemp']").prop('checked', false);
                $("input.MWQMAnalysisTableDataType[name='DataTypeSal']").prop('checked', false);
                $("input.MWQMAnalysisTableDataType[name='DataTypeP90']").prop('checked', false);
                $("input.MWQMAnalysisTableDataType[name='DataTypeGM']").prop('checked', false);
                $("input.MWQMAnalysisTableDataType[name='DataTypeMed']").prop('checked', false);
                $("input.MWQMAnalysisTableDataType[name='DataTypeP43']").prop('checked', false);
                $("input.MWQMAnalysisTableDataType[name='DataTypeP260']").prop('checked', false);
                var ShowDataTypes = $MWQMAnalysisReportParameter.find(".ShowDataTypes").data("showdatatypes");
                var ShowDataTypeList = ShowDataTypes.split(",");
                for (var i = 0, count = ShowDataTypeList.length; i < count; i++) {
                    if (ShowDataTypeList[i].length > 0) {
                        if (ShowDataTypeList[i] == "2") {
                            $("input.MWQMAnalysisTableDataType[name='DataTypeTemp']").prop('checked', true);
                        }
                        if (ShowDataTypeList[i] == "3") {
                            $("input.MWQMAnalysisTableDataType[name='DataTypeSal']").prop('checked', true);
                        }
                        if (ShowDataTypeList[i] == "4") {
                            $("input.MWQMAnalysisTableDataType[name='DataTypeP90']").prop('checked', true);
                        }
                        if (ShowDataTypeList[i] == "5") {
                            $("input.MWQMAnalysisTableDataType[name='DataTypeGM']").prop('checked', true);
                        }
                        if (ShowDataTypeList[i] == "6") {
                            $("input.MWQMAnalysisTableDataType[name='DataTypeMed']").prop('checked', true);
                        }
                        if (ShowDataTypeList[i] == "7") {
                            $("input.MWQMAnalysisTableDataType[name='DataTypeP43']").prop('checked', true);
                        }
                        if (ShowDataTypeList[i] == "8") {
                            $("input.MWQMAnalysisTableDataType[name='DataTypeP260']").prop('checked', true);
                        }
                    }
                }
            ...
            this.MWQMSubsectorAnalysisSaveParametersForReport = function ($bjs) {
                var value = $bjs.closest(".MWQMAnalysisReportParameterTopDiv").find("select[name='MWQMAnalysisReportParameterSave']").val();
                var MWQMAnalysisReportParameterID = parseInt(value);
                if (value == "Export" || value == "Save") {
                    // need to collect all information to send to 
                    var SubsectorTVItemID = parseInt($("#ViewDiv").data("tvitemid"));
                    var AnalysisName = $bjs.closest(".InputSaveParametersForReportDiv").find("input[name='InputAnalysisName']").val();
                    if (!AnalysisName) {
                        cssp.Dialog.ShowDialogError(cssp.GetHTMLVariable("#LayoutVariables", "varAnalysisNameRequired"));
                    }
                    var AnalysisReportYear = $bjs.closest(".InputSaveParametersForReportDiv").find("select[name='AnalysisReportYear']").val();
                    var StartDate = $("select.MWQMSubsectorAnalysisStartDate").val();
                    var EndDate = $("select.MWQMSubsectorAnalysisEndDate").val();
                    var AnalysisCalculationType = $("select.MWQMSubsectorAnalysisCalculateType").val();
                    var NumberOfRuns = $("select.MWQMSubsectorAnalysisRuns").val();
                    var FullYear = $("input.SelectFullYear").is(":Checked") ? true : false;
                    var SalinityHighlightDeviationFromAverage = $("select.MWQMSubsectorAnalysisHighlightSalinityDeviationFromAverage").val();
                    var ShortRangeNumberOfDays = $("input[name='ShortRange']:checked").val();
                    var MidRangeNumberOfDays = $("input[name='MidRange']:checked").val();
                    var DryLimit24h = $("select[name='UpperRainLimitStillConsideredDry1']").val();
                    var DryLimit48h = $("select[name='UpperRainLimitStillConsideredDry2']").val();
                    var DryLimit72h = $("select[name='UpperRainLimitStillConsideredDry3']").val();
                    var DryLimit96h = $("select[name='UpperRainLimitStillConsideredDry4']").val();
                    var WetLimit24h = $("select[name='LowerRainLimitConsideredRain1']").val();
                    var WetLimit48h = $("select[name='LowerRainLimitConsideredRain2']").val();
                    var WetLimit72h = $("select[name='LowerRainLimitConsideredRain3']").val();
                    var WetLimit96h = $("select[name='LowerRainLimitConsideredRain4']").val();
                    var RunsToOmit_1 = ",";
                    $(".jbMWQMSubsectorAnalysisRemoveFromStat").each(function (ind, elem) {
                        if ($(elem).hasClass("btn-danger")) {
                            RunsToOmit_1 = RunsToOmit_1 + $(elem).closest("td.MWQMRun").data("runid") + ",";
                        }
                    });
                    var ShowDataTypes = ",";
                    ...
                    var Command = (value == "Save" ? 1 /* Report */ : 2 /* Excel */);
                    var command_1 = "MWQM/PostAddFormMWQMAnalysisReportParameterJSON";
            ...
            this.MWQMSubsectorAnalysisExportToExcel = function ($bjs) {
                var value = $bjs.closest(".MWQMAnalysisReportParameterTopDiv").find("select[name='MWQMAnalysisExportToExcel']").val();
                var MWQMAnalysisReportParameterID = parseInt(value);
                if (value == "Export" || value == "Save") {
                    // need to collect all information to send to 
                    var SubsectorTVItemID = parseInt($("#ViewDiv").data("tvitemid"));
                    var AnalysisName = $bjs.closest(".InputExportToExcelDiv").find("input[name='InputAnalysisName']").val();
                    if (!AnalysisName) {
                        cssp.Dialog.ShowDialogError(cssp.GetHTMLVariable("#LayoutVariables", "varAnalysisNameRequired"));
                    }
                    var AnalysisReportYear = $bjs.closest(".InputExportToExcelDiv").find("select[name='AnalysisReportYear']").val();
                    var StartDate = $("select.MWQMSubsectorAnalysisStartDate").val();
                    var EndDate = $("select.MWQMSubsectorAnalysisEndDate").val();
                    var AnalysisCalculationType = $("select.MWQMSubsectorAnalysisCalculateType").val();
                    var NumberOfRuns = $("select.MWQMSubsectorAnalysisRuns").val();
                    ...
                    $(".jbMWQMSubsectorAnalysisRemoveFromStat").each(function (ind, elem) {
                        if ($(elem).hasClass("btn-danger")) {
                            RunsToOmit_2 = RunsToOmit_2 + $(elem).closest("td.MWQMRun").data("runid") + ",";
                        }
                    });
                    var ShowDataTypes = ",";
                    ShowDataTypes = ShowDataTypes + ($("input.MWQMAnalysisTableDataType[name='DataTypeFC']").is(":checked") ? "1," /* FC */ : "");
                    ...
                    ShowDataTypes = ShowDataTypes + ($("input.MWQMAnalysisTableDataType[name='DataTypeP260']").is(":checked") ? "8," /* % of P90 > 260 */ : "");
                    var Command = (value == "Save" ? 1 /* Report */ : 2 /* Excel */);
                    var command_2 = "MWQM/PostAddFormMWQMAnalysisReportParameterJSON";
            ...
            this.ReloadAnalysisReportParameter = function () {
                var SubsectorTVItemID = parseInt($("#ViewDiv").data("tvitemid"));
                var command = "MWQM/_mwqmAnalysisReportParameter";
                $.get(cssp.BaseURL + command, {
                    SubsectorTVItemID: SubsectorTVItemID
                }).done(function (ret) {
            ...
            this.MWQMSubsectorAnalysisShowHide = function ($bjs) {
                if ($bjs.hasClass("btn-default")) {
                    ...
                    var command_3 = "MWQM/_mwqmSubsectorAnalysis";
