    ...
    var DocumentButtonEvents = (function () {
        ...
        function DocumentButtonEvents() {
            ...
            this.Init = function () {
                ...
                $(document).on("click", "button[class^='jb']", function (evt) {
                    var $bjs = $(evt.target);
                    if (!$bjs.is("button")) {
                    ...
                    switch ($bjs.attr("class").split(" ")[0]) {
                        ...
                        default:
                            {
                                cssp.Dialog.ShowDialogBasic(new CSSP.DialogModel(CSSP.DialogModelTypeEnum.Error, $bjs.attr("class").split(" ")[0], cssp.GetHTMLVariable("#LayoutVariables", "varNotImplemented")));
                            }
                            break;
                    }
                    return false;
        ...
        return DocumentButtonEvents;
    }());
    CSSP.DocumentButtonEvents = DocumentButtonEvents;
})(CSSP || (CSSP = {}));
//# sourceMappingURL=cssp.DocumentButtonEvents.js.map