...
(function (CSSP) {
    var SamplingPlan = (function () {
        ...
        function SamplingPlan() {
            ...
            this.SamplingPlanDelete = function ($bjs) {
                var SamplingPlanID = parseInt($bjs.closest(".SamplingPlanItem").data("SamplingPlanid"));
            ...
            this.SamplingPlanDeleteSamplingPlan = function ($bjs) {
                var SamplingPlanID = parseInt($bjs.closest(".SamplingPlanItem").data("SamplingPlanid"));
                var command = "SamplingPlan/SamplingPlanDeleteSamplingPlanJSON";
                $.post(cssp.BaseURL + command, {
                    SamplingPlanID: SamplingPlanID
                })
                    .done(function (ret) {
            ...
            this.SamplingPlanShowHistoryLabSheetDetail = function ($bjs) {
                if ($bjs.hasClass("btn-default")) {
                    ...
                    var $LabSheetHistoryDetailDiv = $bjs.closest(".SamplingPlanItem").find(".LabSheetHistoryDetailDiv").eq(0);
                    ...
                    $bjs.removeClass("btn-success").addClass("btn-default");
                    $bjs.closest(".SamplingPlanItem").find(".LabSheetHistoryDetailDiv").eq(0).html("");
                }
            };
            ...
            this.SamplingPlanApproveLabSheet = function ($bjs) {
                ...
                var command = "SamplingPlan/LabSheetApprovedJSON";
            ...
            this.SamplingPlanNotApproveLabSheet = function ($bjs) {
                var LabSheetID = parseInt($bjs.data("labsheetid"));
                var command = "SamplingPlan/LabSheetNotApprovedJSON";
        ...
        SamplingPlan.prototype.ResetCountMWQMSiteSelected = function ($Item) {
            ...
            $Item.closest(".SamplingPlanSubsectorEditForm").find(".SamplingPlanMWQMSiteSave").text("Modify");
...
//# sourceMappingURL=cssp.MWQMPlan.js.map